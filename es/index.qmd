...
::: card
### Biomarcadores de recurrencia de cáncer colorectal

Investigo biomarcadores de recurrencia en cáncer colorrectal para mejorar la predicción pronóstica y personalizar el seguimiento de los pacientes, con especial interés en aminas biogénicas como la espermidina.

![](images_es/divulgacion/medios.png){width="300px" style="margin-left: 0px;margin-bottom:20px;"}

<br>

[Enlace a la publicación →](2024_Spermidine CRC.pdf)

**Enfoque:** Biomarcadores · Investigación clínica · Metabolómica
:::
